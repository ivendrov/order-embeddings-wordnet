...
function displayData(e) {
    ...
    function allModelsHave(dataName){
        return _.every(models, function(model) { return model.data.hasOwnProperty(dataName)})
    }
    ...
    data_streams.forEach(function(dataName){
        if (allModelsHave("Training" + dataName)){
            if (allModelsHave(dataName)){
                charts.push([dataName, "Training" + dataName]);
            } else{
                charts.push(["Training" + dataName])
            }
        } else {
...
function displayModels(){
    ...
    var all_data_names = models.map(function(model){
        return _.uniq(_.keys(model.data).map(stripTraining).sort(function(a,b) {
